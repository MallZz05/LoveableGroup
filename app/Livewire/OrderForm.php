...
class OrderForm extends Component
{
    ...
    public function mount(Book $book, $orderData)
    {
        $this->book = $book;
        $this->orderData = $orderData;
        $this->subTotalAmount = $book->price;
        $this->grandTotalAmount = $book->price;
    }
    ...
    {
        $this->subTotalAmount = $this->book->price * $this->quantity;
    ...
    public function applyPromoCode()
    {
        ...
        if (isset($result['error'])) {
            ...
            session()->flash('message', 'Yayy, kode promo tersedia!');
