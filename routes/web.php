...
Route::get('/details/{book:slug}', [FrontController::class, 'details'])->name('front.details');
Route::post('/order/begin/{book:slug}', [OrderController::class, 'saveOrder'])->name('front.save_order');
