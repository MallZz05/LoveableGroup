            ...
            <section id="your-order" class="accordion flex flex-col rounded-[20px] p-4 pb-5 gap-5 mx-4 bg-white overflow-hidden transition-all duration-300 has-[:checked]:!h-[66px]">
                ...
                <div class="flex items-center gap-[14px]">
                    <div class="flex shrink-0 w-20 h-20 rounded-[20px]  p-1 overflow-hidden">
                        <img src="{{Storage::url($orderDetails->book->thumbnail)}}" class="w-full h-full object-contain" alt="">
                    </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="font-bold">{{$orderDetails->book->author->name}}</p>
                </div>
                <div class="flex items-center justify-between">
                    <p class="font-semibold">Publisher</p>
                    <p class="font-bold">{{$orderDetails->book->publisher->name}}</p>
                </div>
                <div class="flex items-center justify-between">
                    <p class="font-semibold">Price</p>
                    <p class="font-bold">Rp {{number_format($orderDetails->book->price)}}</p>
                </div>
                <div class="flex items-center justify-between">
